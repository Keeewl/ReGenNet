...
from stage2_old.common.restored.restored_space import SUPPORTED_BODY_MODEL_TYPE
from stage2_old.proposal.train.contact_proposal_training_loop import ContactProposalTrainLoop
