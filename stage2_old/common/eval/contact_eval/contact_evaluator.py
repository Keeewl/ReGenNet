...
from stage2_old.common.eval.contact_eval.contact_metrics import (
    compute_hand_cd,
...
from stage2_old.common.eval.contact_eval.contact_segments import build_union_contact_mask
