...
from model.contact.contact_defs import BAND_IDS, HAND_SIDES, PHASE_IDS, TARGET_PARTS
from model.crefine.mesh_regions import WINDOW_STATE_IDS, WINDOW_STATE_NAMES
