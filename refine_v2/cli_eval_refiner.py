...
def main(argv=None):
    ...
    loss_fn = RefineV2Loss(
        RefineV2LossConfig(
            ...
            phase_preserve_root_weight=float(train_cfg.get("phase_preserve_root_weight", 1.0)),
            phase_preserve_lower_body_weight=float(train_cfg.get("phase_preserve_lower_body_weight", 0.5)),
            phase_preserve_torso_weight=float(train_cfg.get("phase_preserve_torso_weight", 0.3)),
            phase_preserve_arm_weight=float(train_cfg.get("phase_preserve_arm_weight", 0.1)),
            phase_preserve_hand_weight=float(train_cfg.get("phase_preserve_hand_weight", 0.05)),
