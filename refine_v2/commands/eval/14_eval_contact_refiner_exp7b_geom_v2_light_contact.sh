...
####### refine_v2 exp7b: contact eval for geometry v2 + light contact ablation #######
...
python -m refine_v2.cli_eval_contact_refiner \
  ...
  --output_dir refine_v2/save/train/refiner_v2_exp7b_geom_v2_light_contact_10k/contact_eval_window \
