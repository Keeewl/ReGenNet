...
####### refine_v2 exp7b: window-level eval for geometry v2 + light contact ablation #######
...
python -m refine_v2.cli_eval_refiner \
  ...
  --device cuda \
  --output_json refine_v2/save/train/refiner_v2_exp7b_geom_v2_light_contact_10k/eval_window.json
