...
####### refine_v2 exp8: window-level eval for lightweight hand-target interaction refiner #######
...
python -m refine_v2.cli_eval_refiner \
  ...
  --device cuda \
  --output_json refine_v2/save/train/refiner_v2_exp8_interaction_v1_10k/eval_window.json
