...
SUMMARY_GLOB=${SUMMARY_GLOB:-refine_v2/save/interx_offline_table/hireact_seed*/hireact_dryrun/table1_hireact_dryrun_summary.json}
OUT_DIR=${OUT_DIR:-refine_v2/save/interx_offline_table/hireact_aggregate}
