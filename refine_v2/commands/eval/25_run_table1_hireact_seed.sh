...
STAGE1_MODEL_PATH=${STAGE1_MODEL_PATH:-save/cnet_v5_256/interx_smplx_online_exp1/model000209455.pt}
...
ROOT_DIR=${ROOT_DIR:-refine_v2/save/table1/hireact_seed${SEED}}
