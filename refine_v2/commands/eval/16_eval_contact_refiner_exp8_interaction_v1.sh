...
####### refine_v2 exp8: contact eval for lightweight hand-target interaction refiner #######
...
python -m refine_v2.cli_eval_contact_refiner \
  ...
  --output_dir refine_v2/save/train/refiner_v2_exp8_interaction_v1_10k/contact_eval_window \
