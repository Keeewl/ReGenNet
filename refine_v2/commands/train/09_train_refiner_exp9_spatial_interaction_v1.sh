...
####### refine_v2 exp9: stronger but still lightweight hand-target spatial interaction, 10k steps #######
...
python -m refine_v2.cli_train_refiner \
  ...
  --save_dir refine_v2/save/train/refiner_v2_exp9_spatial_interaction_v1_10k \
  --batch_size 32 \
  --num_workers 4 \
  --device cuda \
  --val_ratio 0.1 \
