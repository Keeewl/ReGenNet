...
####### refine_v2 exp7b: export vis pack for geometry v2 + light contact ablation #######
export CUDA_VISIBLE_DEVICES=0
python -m refine_v2.cli_export_refiner_vis_pack \
  --checkpoint refine_v2/save/train/refiner_v2_exp7b_geom_v2_light_contact_10k/model_best.pt \
  ...
  --contact_eval_json refine_v2/save/train/refiner_v2_exp7b_geom_v2_light_contact_10k/contact_eval_window/eval_contact_refiner.json \
  --output_dir refine_v2/save/train/refiner_v2_exp7b_geom_v2_light_contact_10k/vis_pack_random20 \
