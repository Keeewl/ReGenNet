...
####### refine_v2 exp6: export vis pack for transl-only phase refiner #######
...
python -m refine_v2.cli_export_refiner_vis_pack \
  ...
  --contact_eval_json refine_v2/save/train/refiner_v2_exp6_transl_phase_10k/contact_eval_window/eval_contact_refiner.json \
  --output_dir refine_v2/save/train/refiner_v2_exp6_transl_phase_10k/vis_pack_random20 \
