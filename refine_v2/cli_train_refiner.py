...
def build_parser():
    ...
    parser.add_argument("--use_hand_target_interaction", action="store_true")
    parser.add_argument("--use_hand_target_spatial_attention", action="store_true")
    parser.add_argument("--use_focused_hand_arm_boost", action="store_true")
    parser.add_argument("--use_group_gated_residual", action="store_true")
    parser.add_argument("--interaction_num_layers", type=int, default=1)
    parser.add_argument("--interaction_num_heads", type=int, default=4)
    parser.add_argument("--hand_interaction_boost_scale", type=float, default=0.35)
    parser.add_argument("--arm_interaction_boost_scale", type=float, default=0.2)
